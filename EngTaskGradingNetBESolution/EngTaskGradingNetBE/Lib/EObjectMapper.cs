...
public static class EObjectMapper
{
  ...
  public static CourseDto To(Course course) => new(course.Id, course.Code, course.Name, course.IsActive, course.Students?.Count ?? -1, course.Tasks?.Count ?? -1, course.Attendances?.Count ?? -1);
