...
namespace EngGradesBE.Migrations
{
    ...
    [Migration("20260212170640_AddAttendanceDaySelfSignUniqueIndexII")]
    partial class AddAttendanceDaySelfSignUniqueIndexII
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EngTaskGradingNetBE.Models.DbModel.AttendanceDay", b =>
                {
                    ...
                    b.Property<string>("SelfAssignKey")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EngTaskGradingNetBE.Models.DbModel.AttendanceRecord", b =>
                {
                    ...
                    b.Property<int>("AttendanceValueId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EngTaskGradingNetBE.Models.DbModel.FinalGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EngTaskGradingNetBE.Models.DbModel.StudentViewToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EngTaskGradingNetBE.Models.DbModel.AttendanceRecord", b =>
                {
                    ...
                    b.HasOne("EngTaskGradingNetBE.Models.DbModel.AttendanceValue", "Value")
                        .WithMany()
                        .HasForeignKey("AttendanceValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
