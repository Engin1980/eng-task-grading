...
interface EditCourseFinalGradeModalProps {
  ...
  grade: FinalGradeDto | null;
  onGradeUpdated: (updatedGrade: FinalGradeDto) => void;
}

export function EditCourseFinalGradeModal({ isOpen, onClose, student, grade, onGradeUpdated }: EditCourseFinalGradeModalProps) {
          ...
          <div className="px-6 py-4">
            ...
            <div className="mb-4">
              <label htmlFor="grade-value" className="block text-sm font-medium text-gray-700 mb-2">
                Nová známka (0-100, min 50) <span className="text-red-500">*</span>
              </label>
              <input
                id="grade-value"
                type="number"
