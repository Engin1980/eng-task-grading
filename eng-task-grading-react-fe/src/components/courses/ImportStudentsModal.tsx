...
// import { StudentAnalysisResultModal } from './ImportStudentsWizardSecondModal';
// import type { StudentAnalysisResultDto } from '../../model/student-dto';

// interface ImportStudentWizardModalProps {
//   isOpen: boolean;
//   onClose: () => void;
//   onImport: (text: string) => void;
// }

// export function ImportStudentWizardModal({ isOpen, onClose, onImport }: ImportStudentWizardModalProps) {
//   const [importText, setImportText] = useState('');
//   const [isLoading, setIsLoading] = useState(false);
//   const [analysisResult, setAnalysisResult] = useState<StudentAnalysisResultDto | null>(null);
//   const [isAnalysisModalOpen, setIsAnalysisModalOpen] = useState(false);
//   const logger = useLogger("ImportStudentWizardModal");
